...
if __name__ == "__main__":
    ...
    std_cda = df["CdA_est"].std()
    print(f"Standard Deviation of CdA: {std_cda:.4f} m²")
    # Mean of acceleration bias
    mean_accel_bias = df["accel_bias"].mean()
    print(f"Mean Acceleration Bias: {mean_accel_bias:.4f} m/s²")
    std_accel_bias = df["accel_bias"].std()
    print(f"Standard Deviation of Acceleration Bias: {std_accel_bias:.4f} m/s²")
    # RMSE of velocity
